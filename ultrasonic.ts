...
namespace Ultraschall {
   ...
   * @param trig pin connected to trig, eg: DigitalPin.C16
   * @param echo pin connected to echo, eg: DigitalPin.C17
   */
  //% blockId="makerbit_ultrasonic_connect"
  //% block="Ultraschallsensor | mit Trig an %trig | und Echo an %echo"
  ...
  //% block="Objekt erkannt in | %distance | %unit"
  //% weight=69
  ...
  //% block="Entfernung geringer als | %distance | %unit"
  //% weight=50
